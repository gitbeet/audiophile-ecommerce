          ...
          <div className='checkout-form-desktop-form'>
            ...
            <fieldset>
              <div className='form-payment-method'>
                ...
                <div className={`${formik.errors.paymentMethod && formik.touched.paymentMethod ? 'checkout-form-label payment-methods-label error-text show' : 'checkout-form-label payment-methods-label error-text hide'}`} ><p>{formik.errors.paymentMethod}</p></div>
